...
import { ChevronDown, Sparkles, Scissors, Heart, HandMetal, Baby } from "lucide-react";
    ...
    <section id="services" className="py-20 md:py-28 relative">
      <div className="container px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold gold-text">Our Services</h2>
