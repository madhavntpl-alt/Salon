    ...
    <section id="services" className="py-20 md:py-28 relative" aria-labelledby="services-heading">
      <div className="container px-4">
        ...
        >
          ...
          <p className="font-elegant text-lg text-muted-foreground mt-2 italic">Women & Kids Only</p>
        </motion.div>
          ...
          {categories.map((cat, idx) => (
            ...
            >
              <Card3DTilt
                maxTilt={3}
                scale={1.008}
                className="rounded-xl border border-primary/20 bg-card/90 overflow-hidden glow-gold-hover transition-all duration-200"
              >
                <button
